...
class Telegram:
    ...
    DATABASE_URL = str(env.get('DATABASE_URL', 'mongodb+srv://tt:tt@cluster0.6bfxqdl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'))
    UPDATES_CHANNEL = str(env.get('UPDATES_CHANNEL', "-1002091501875"))
